! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t(require("moment"), require("define_me"), require("bulletproof_me"), require("whats_wrong")) : "function" == typeof define && define.amd ? define(["moment", "define_me", "bulletproof_me", "whats_wrong"], t) : "object" == typeof exports ? exports.when_you_free = t(require("moment"), require("define_me"), require("bulletproof_me"), require("whats_wrong")) : e.when_you_free = t(e.moment, e.define_me, e.bulletproof_me, e.whats_wrong) }(this, (function(e, t, n, r) {
    return (() => {
        ...
        var s = {};
        return (() => {
            a.r(s), a.d(s, { catchError: () => w, createDay: () => i, createFullDate: () => u, createHour: () => n, createMinute: () => r, createMonth: () => o, dateIsWithinLimit: () => D, difference: () => S, digitalToSeconds: () => A, format: () => I, formatDateToPost: () => j, formatString: () => y, getDuration: () => M, getReadableFormat: () => _, getType: () => g, isBefore: () => b, isBetween: () => v, isDate: () => Y });
            var e = a(896),
                t = a.n(e);
            ...
            function y(e) {
                var t, n = (e = (e = e.replaceAll(",", "")).toLowerCase().trim()).split(" "),
                    r = parseInt(n[1]);
                if (console.log("day"), (0, m.STARTSWITH)(e, "j")) t = p.Jan;
            ...
            function T(e) { return e.map(Number) }
            ...
            function g(e) {
                return (0, c.containsThis)(e, c.hhmm) || (0, c.containsThis)(e, c.hhmmss) ? (o = e.split(":"), a = T(o), 2 === o.length ? r(a[0], a[1]) : 3 === o.length ? n(a[0], a[1], a[2]) : void 0) : (0, c.containsThis)(e, c.dashDDMMYYYY) || (0, c.containsThis)(e, c.dashYYYYMMDD) ? function(e) {
                    var t = e.split("/"),
                        n = T(t);
                    ...
                    var t = e.split("-"),
                        n = T(t);
                    return 4 === t[0].length ? i(n[0], n[1], n[2]) : i(n[2], n[1], n[0])
                }(e) : (0, c.containsThis)(e, c.yyyymmdd) ? (u = (s = e).slice(0, 4), f = s.slice(4, 6), m = s.slice(6, 8), i(parseInt(u), parseInt(f), parseInt(m))) : (0, c.containsThis)(e, c.knexDate) ? t()(e) : (0, c.containsThis)(e, c.stringDate) ? y(e = (e = e.replaceAll(",", "")).toLowerCase().trim()) : (e instanceof Date || !!t()(e).isValid()) && t()(e);
                var o, a, s, u, f, m
            }

            function w(e) { return void 0 !== e && "object" === d(e) || (0, l.upset)("not a valid date" + e, "when_you_free module") }
            ...
            function M(t, n, r) {
                var o = g(t),
                    ...
                    a = w(o),
                    s = w(i);
                return !0 == (!0 === a && !0 === s) ? (0, e.duration)({ from: o, to: i }).as(r) : (0, l.upset)("something wrong with date - get duration function", "when_you_free/duration.js")
            }
